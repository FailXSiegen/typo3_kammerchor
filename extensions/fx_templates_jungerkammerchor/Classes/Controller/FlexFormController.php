...
namespace Failx\FxTemplatesJungerkammerchor\Controller;
 ...
 * @package Failx\FxTemplatesJungerkammerchor\Controller
 */
class FlexFormController
{
        ...
        switch ($columnType) {
            ...
            case 'mdCol':
                ...
                if (isset($config['flexParentDatabaseRow']['pi_flexform']['data']) && count($config['flexParentDatabaseRow']['pi_flexform']['data']) == 0) {
                    $optionListStart = [
                        $defaultOption,
                        ['LLL:EXT:fx_templates_jungerkammerchor/Resources/Private/Language/locallang_db.xlf:grid.label.notset', ' ']
                    ];
                } else {
                    $optionListStart = [
                        ['LLL:EXT:fx_templates_jungerkammerchor/Resources/Private/Language/locallang_db.xlf:grid.label.notset', ' '],
                ...
                $optionList = array_merge($optionListStart, [
                    ...
                    [
                        'LLL:EXT:fx_templates_jungerkammerchor/Resources/Private/Language/locallang_db.xlf:grid.label.moreWidth',
                        '--div--'
                    ],
                    ...
                    [
                        'LLL:EXT:fx_templates_jungerkammerchor/Resources/Private/Language/locallang_db.xlf:grid.label.moreOptions',
                        '--div--'
                    ],
                    [
                        'LLL:EXT:fx_templates_jungerkammerchor/Resources/Private/Language/locallang_db.xlf:grid.label.hidden',
                        'd-md-none'
                    ],
                    [
                        'LLL:EXT:fx_templates_jungerkammerchor/Resources/Private/Language/locallang_db.xlf:grid.label.visible',
                        'd-md-block'
                    ]
                ]);
                break;
            ...
            case 'xsCol':
                $optionList = [
                    ...
                    ['LLL:EXT:fx_templates_jungerkammerchor/Resources/Private/Language/locallang_db.xlf:grid.label.hidden', 'd-none'],
                    ['LLL:EXT:fx_templates_jungerkammerchor/Resources/Private/Language/locallang_db.xlf:grid.label.visible', 'd-block']
                ];
                break;
